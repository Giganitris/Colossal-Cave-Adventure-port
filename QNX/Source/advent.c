...
#include <string.h>
#include <stdlib.h>
#define memset(l,s,c)  memset(l,c,s)
#endif
...
initplay()
{
	...
	memset(cond, (sizeof(int))*MAXLOC, 0); 
	...
	memset(place, (sizeof(int))*MAXOBJ, 0); 
	...
	memset(fixed, (sizeof(int))*MAXOBJ, 0); 
	...
	memset(visited, (sizeof(int))*MAXLOC, 0);
	memset(prop, (sizeof(int))*MAXOBJ, 0);
	memset(&prop[50], (sizeof(int))*(MAXOBJ-50), 0xff); 
...
#define ADV1 "advent1.txt"
#define ADV2 "advent2.txt"
#define ADV3 "advent3.txt"
#define ADV4 "advent4.txt"
